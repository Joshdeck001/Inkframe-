    ...
    <>
      ...
      <div className="wrap">
        ...
        <p className="subtitle">
          Cover concepts InkFrame drafted for your books — as image-generation prompts. Rendering actual
          artwork needs an image-generation key that isn&apos;t wired in yet.
        </p>
        ...
        {effectiveId && (
          <div className="panel">
            ...
            {concepts?.map((c, i) => (
              <div key={i} style={{ marginBottom: "14px", fontSize: "13px" }}>
