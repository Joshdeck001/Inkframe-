    ...
    <>
      ...
      <div className="wrap">
        ...
        <p className="subtitle">
          Cover concepts InkFrame drafted for your books, with real artwork generated by OpenAI or Gemini
          where a concept has finished rendering. A concept without an image above it means generation isn&apos;t
          available yet (no billing-enabled OpenAI or Gemini key) — the prompt below is still ready to use by hand.
        </p>
